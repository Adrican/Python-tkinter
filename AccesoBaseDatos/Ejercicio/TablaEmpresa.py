    ...
    try:
        ...
        while aux:   
            ...
            if aux=="1":   
                ...
                alumno.tipo=input ("Introduce el tipo (empleado o cliente): ")
                alumno.nombre_curso=input ("Introduce el curso: ") 
                alumno.fecha_inscripcion=input ("Introduce la fecha de inscripcion: ")
                alumno.horas_curso=input ("Introduce las horas del curso: ")  
                alumno.precio=input ("Introduce el precio: ")          
                ...
                cur.execute("INSERT INTO alumnos (id, nombre, tipo, nombre_curso, fecha_inscripcion, horas_curso, precio) VALUES (%s, %s, %s, %s, %s, %s, %s)",(alumno.id, alumno.nombre, alumno.tipo, alumno.nombre_curso, alumno.fecha_inscripcion, alumno.horas_curso, alumno.precio))
